#ifndef __GRAPH_L1_B6_A0_C0_H__
#define __GRAPH_L1_B6_A0_C0_H__
...
class simpleGraph_k3_L1_B6_A0_C0: public graph {
  public:
    kernel mm[L1_NUM_KERNEL];
    port<input> in[L1_NUM_KERNEL];
    port<output> out;
    
    simpleGraph_k3_L1_B6_A0_C0() {
      ...
      mm[5] = kernel::create(mm3_kernel2_L1_B5_A0_C0);
      source(mm[5]) = "mm3_kernel2_L1_B5_A0_C0.cc";
