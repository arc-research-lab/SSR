#ifndef __GRAPH_L1_B6_A0_C5_H__
#define __GRAPH_L1_B6_A0_C5_H__
...
class simpleGraph_k3_L1_B6_A0_C5: public graph {
  public:
    kernel mm[L1_NUM_KERNEL];
    port<input> in[L1_NUM_KERNEL];
    port<output> out;
    
    simpleGraph_k3_L1_B6_A0_C5() {
      
      mm[0] = kernel::create(mm3_kernel0_L1_B0_A0_C5);
      source(mm[0]) = "mm3_kernel0_L1_B0_A0_C5.cc";
      mm[1] = kernel::create(mm3_kernel1_L1_B1_A0_C5);
      source(mm[1]) = "mm3_kernel1_L1_B1_A0_C5.cc";
      mm[2] = kernel::create(mm3_kernel1_L1_B2_A0_C5);
      source(mm[2]) = "mm3_kernel1_L1_B2_A0_C5.cc";
      mm[3] = kernel::create(mm3_kernel1_L1_B3_A0_C5);
      source(mm[3]) = "mm3_kernel1_L1_B3_A0_C5.cc";
      mm[4] = kernel::create(mm3_kernel1_L1_B4_A0_C5);
      source(mm[4]) = "mm3_kernel1_L1_B4_A0_C5.cc";
      mm[5] = kernel::create(mm3_kernel2_L1_B5_A0_C5);
      source(mm[5]) = "mm3_kernel2_L1_B5_A0_C5.cc";
