#ifndef __GRAPH_L1_B6_A0_C1_H__
#define __GRAPH_L1_B6_A0_C1_H__
...
class simpleGraph_k3_L1_B6_A0_C1: public graph {
  public:
    kernel mm[L1_NUM_KERNEL];
    port<input> in[L1_NUM_KERNEL];
    port<output> out;
    
    simpleGraph_k3_L1_B6_A0_C1() {
      ...
      mm[5] = kernel::create(mm3_kernel2_L1_B5_A0_C1);
      source(mm[5]) = "mm3_kernel2_L1_B5_A0_C1.cc";
