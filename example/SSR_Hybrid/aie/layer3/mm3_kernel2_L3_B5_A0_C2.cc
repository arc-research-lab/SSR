...
#include <stdio.h>
#include "para_L3.h"
#include "parameter_L3_B5_A0_C2.h"

void mm3_kernel2_L3_B5_A0_C2(input_window_int8* __restrict matA, 
    ...
    for (int seq=0;seq<L3_bound_seq1;seq++)
	    chess_prepare_for_pipelining
	    chess_loop_range(L3_bound_seq1,)
    {
	    ...
	    chess_loop_range(2,)
        {
            ...
            { //OC/4
	            ...
	            window_incr(matC,L3_jumpC0);
            }
            window_incr(matA,L3_jumpA1);
            matB -=L3_jumpB3/32;
            window_decr(matC,L3_jumpC1);
        }
        window_incr(matC,L3_jumpC2);
    }
}