#ifndef __GRAPH_L4_B2_A0_C0_H__
#define __GRAPH_L4_B2_A0_C0_H__
...
class simpleGraph_k7_L4_B2_A0_C0: public graph {
  public:
    kernel mm[L4_NUM_KERNEL];
    port<input> in[L4_NUM_KERNEL];
    port<output> out;
    
    simpleGraph_k7_L4_B2_A0_C0() {
      
      mm[0] = kernel::create(mm7_kernel0_L4_B0_A0_C0);
      source(mm[0]) = "mm7_kernel0_L4_B0_A0_C0.cc";
      mm[1] = kernel::create(mm7_kernel2_L4_B1_A0_C0);
      source(mm[1]) = "mm7_kernel2_L4_B1_A0_C0.cc";
