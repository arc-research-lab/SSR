...
#include "../aie/layer8/aie_top_L8.h"
#include "../aie/layer9/aie_top_L9.h"
...
int main(int argc, char** argv) {
    ...
    auto ghdl5=xrt::graph(device,uuid,"vit_graph5");
    auto ghdl6=xrt::graph(device,uuid,"vit_graph6");
    auto ghdl7=xrt::graph(device,uuid,"vit_graph7");
    auto ghdl8=xrt::graph(device,uuid,"vit_graph8");
    auto ghdl9=xrt::graph(device,uuid,"vit_graph9");
    ...
    ghdl1.update("vit_graph1.vit_0_0_0.mm[0].in[1]",weights_offset);
    ghdl1.update("vit_graph1.vit_0_1_0.mm[0].in[1]",weights_offset);
    ghdl1.update("vit_graph1.vit_0_2_0.mm[0].in[1]",weights_offset);
    ghdl1.update("vit_graph1.vit_0_3_0.mm[0].in[1]",weights_offset);
    ghdl1.update("vit_graph1.vit_0_4_0.mm[0].in[1]",weights_offset);
    ghdl1.update("vit_graph1.vit_0_5_0.mm[0].in[1]",weights_offset);
    
    ghdl2.update("vit_graph2.vit_0_0_0.mm[0].in[1]",weights_offset);
    ghdl2.update("vit_graph2.vit_0_1_0.mm[0].in[1]",weights_offset);
    ghdl2.update("vit_graph2.vit_0_2_0.mm[0].in[1]",weights_offset);
    ghdl2.update("vit_graph2.vit_0_3_0.mm[0].in[1]",weights_offset);
    ghdl2.update("vit_graph2.vit_0_4_0.mm[0].in[1]",weights_offset);
    ghdl2.update("vit_graph2.vit_0_5_0.mm[0].in[1]",weights_offset);
    
    ghdl5.update("vit_graph5.vit_0_0_0.mm[0].in[1]",weights_offset);
    ghdl5.update("vit_graph5.vit_0_1_0.mm[0].in[1]",weights_offset);
    ghdl5.update("vit_graph5.vit_0_2_0.mm[0].in[1]",weights_offset);
    ghdl5.update("vit_graph5.vit_0_3_0.mm[0].in[1]",weights_offset);
    
    ghdl6.update("vit_graph6.vit_0_0_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_1_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_2_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_3_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_4_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_5_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_6_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_7_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_8_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_9_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_10_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_11_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_12_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_13_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_14_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_15_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_16_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_17_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_18_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_19_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_20_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_21_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_22_0.mm[0].in[1]",weights_offset);
    ghdl6.update("vit_graph6.vit_0_23_0.mm[0].in[1]",weights_offset);
    
    ghdl7.update("vit_graph7.vit_0_0_0.mm[0].in[1]",weights_offset);
    ghdl7.update("vit_graph7.vit_0_1_0.mm[0].in[1]",weights_offset);
    ghdl7.update("vit_graph7.vit_0_2_0.mm[0].in[1]",weights_offset);
    ghdl7.update("vit_graph7.vit_0_3_0.mm[0].in[1]",weights_offset);
    ...
    int soft_iteration=1000;
    for (int i = 0; i < soft_iteration; i++) {
    ...
    std::cout << "Time per iteration is: "<< (kernel_time_in_sec/soft_iteration/iter*1000) <<" ms" << std::endl;
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    if(verify){
        ...
        // transpose_data(golden_L0_OUT, golden, ACC0_M7, ACC0_N7);
