...
#include <stdio.h>
#include "para_L8.h"
#include "parameter_L8_B10_A0_C2.h"

void mm3_kernel1_L8_B10_A0_C2(input_window_int8* __restrict matA, 
    ...
    for (int seq=0;seq<L8_bound_seq;seq++)
	    chess_prepare_for_pipelining
	    chess_loop_range(L8_bound_seq,)
    {// SEQ/4
