...
void mm1_kernel3_L3(input_window_int8* __restrict matA,
    ...
    for (int i=0;i<L3_boundry_i;i++)
	chess_prepare_for_pipelining
	chess_loop_range(L3_boundry_i,)
	{ //h1/8
        for (int j=0;j<L3_boundry_j;j++)
	    chess_prepare_for_pipelining
	    chess_loop_range(L3_boundry_j,)
        { //W2/8
            ...
            window_incr(matA,L3_jumpA0);
            buf_matB1=window_read_v32(matB);
            window_decr(matB,L3_jumpB2);
            
            acc1=mac16(acc1,buf_matA0,0,0x11101110,16,0x3120,buf_matB0,0,0xCCCC8888,2,0x3210); 
	        buf_matA1=upd_w(buf_matA1,1,window_read_v32(matA));
	        window_incr(matA,L3_jumpA2);
        ...
        window_decr(matA,L3_jumpA1);
        window_decr(matB,L3_jumpB1);
    }
