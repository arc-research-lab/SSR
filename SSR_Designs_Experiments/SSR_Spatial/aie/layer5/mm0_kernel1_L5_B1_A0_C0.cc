...
#include <stdio.h>
#include "para_L5.h"
#include "parameter_L5_B1_A0_C0.h"

void mm0_kernel1_L5_B1_A0_C0(input_window_int8* __restrict matA, 
    ...
    for (int i=0;i<L5_boundry_i;i++)
	chess_prepare_for_pipelining
	chess_loop_range(L5_boundry_i,)
	{ //h1/8
        for (int j=0;j<L5_boundry_j;j++)
	    chess_prepare_for_pipelining
	    chess_loop_range(L5_boundry_j,)
        { //W2/8
