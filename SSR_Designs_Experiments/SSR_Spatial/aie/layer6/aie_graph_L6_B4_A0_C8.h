#ifndef __GRAPH_L6_B4_A0_C8_H__
#define __GRAPH_L6_B4_A0_C8_H__
...
class simpleGraph_k0_L6_B4_A0_C8: public graph {
  private:
  ...
  public:
    ...
    simpleGraph_k0_L6_B4_A0_C8() {
      
      mm[0] = kernel::create(mm0_kernel0_L6_B0_A0_C8);
      source(mm[0]) = "mm0_kernel0_L6_B0_A0_C8.cc";
      mm[1] = kernel::create(mm0_kernel1_L6_B1_A0_C8);
      source(mm[1]) = "mm0_kernel1_L6_B1_A0_C8.cc";
      mm[2] = kernel::create(mm0_kernel1_L6_B2_A0_C8);
      source(mm[2]) = "mm0_kernel1_L6_B2_A0_C8.cc";
      mm[3] = kernel::create(mm0_kernel2_L6_B3_A0_C8);
      source(mm[3]) = "mm0_kernel2_L6_B3_A0_C8.cc";
