#ifndef __GRAPH_L2_B2_A0_C1_H__
#define __GRAPH_L2_B2_A0_C1_H__
...
class simpleGraph_k7_L2_B2_A0_C1: public graph {
  public:
    kernel mm[L2_NUM_KERNEL];
    port<input> in[L2_NUM_KERNEL];
    port<output> out;
    
    simpleGraph_k7_L2_B2_A0_C1() {
      
      mm[0] = kernel::create(mm7_kernel0_L2_B0_A0_C1);
      source(mm[0]) = "mm7_kernel0_L2_B0_A0_C1.cc";
      mm[1] = kernel::create(mm7_kernel2_L2_B1_A0_C1);
      source(mm[1]) = "mm7_kernel2_L2_B1_A0_C1.cc";
